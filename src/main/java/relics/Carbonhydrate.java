...
public class Carbonhydrate extends CustomRelic {
    public static final String ID = "Carbonhydrate";

    public Carbonhydrate() {
        super(ID, new Texture("chrono_images/relics/Carbonhydrate.png"), new Texture("chrono_images/relics/outline/Carbonhydrate.png"), RelicTier.UNCOMMON, LandingSound.CLINK);
    }
