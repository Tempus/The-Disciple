...
public class LockedHand extends MetricsCard {
	...
	public LockedHand() {
		super(ID, NAME, "images/cards/LockedHand.png", COST, DESCRIPTION, AbstractCard.CardType.POWER,
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
    	...
    	AbstractDungeon.actionManager.addToBottom(new ChannelAction(new UnlockedHand(this.upgraded)));
   	}
