...
public class LockedCarbon extends MetricsCard {
	...
	public LockedCarbon() {
		super(ID, NAME, "chrono_images/cards/LockedCarbon.png", COST, DESCRIPTION, AbstractCard.CardType.POWER,
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
    	AbstractDungeon.actionManager.addToBottom(new ChronoChannelAction(new UnlockedCarbon(this.upgraded)));
   	}
