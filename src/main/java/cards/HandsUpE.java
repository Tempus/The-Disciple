...
import chronomuncher.powers.StrengthDamagePower;

import basemod.ReflectionHacks;
import com.badlogic.gdx.graphics.Color;

public class HandsUpE extends MetricsCard {
	public static final String ID = "HandsUpE";
	...
	public HandsUpE() {
		...
		ReflectionHacks.setPrivate(this, AbstractCard.class, "tintColor", Color.PURPLE.cpy());
	}
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
		...
		AbstractDungeon.actionManager.addToBottom(
			new ApplyPowerAction(m, p, new StrengthDamagePower(m), 1, true, AbstractGameAction.AttackEffect.NONE));
	}
