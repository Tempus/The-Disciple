...
public class ArtifactorA
  extends AbstractImageEvent
{
  public static final String ID = "ArtifactorA";
  private static final EventStrings eventStrings = CardCrawlGame.languagePack.getEventString("ArtifactorA");
  ...
  public ArtifactorA()
  {
    super(NAME, DIALOG_1, "chrono_images/events/ArtifactorA.png");
