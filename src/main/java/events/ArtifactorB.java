...
public class ArtifactorB
  extends AbstractImageEvent
{
  public static final String ID = "ArtifactorB";
  private static final EventStrings eventStrings = CardCrawlGame.languagePack.getEventString("ArtifactorB");
  ...
  public ArtifactorB()
  {
    super(NAME, DIALOG_1, "chrono_images/events/ArtifactorB.png");
    this.imageEventText.setDialogOption(OPTIONS[0], CardLibrary.getCopy("LockedMercury"));
    this.imageEventText.setDialogOption(OPTIONS[1], CardLibrary.getCopy("LockedCarbon"));
    this.imageEventText.setDialogOption(OPTIONS[2], CardLibrary.getCopy("LockedWhetstone"));
  ...
  protected void buttonEffect(int buttonPressed)
  {
    ...
    case 0: 
      ...
      case 1: 
        this.screenNum = 2;
        this.imageEventText.updateBodyText(REPLICATE_RESULT);
        AbstractDungeon.getCurrRoom().spawnRelicAndObtain(Settings.WIDTH / 2, Settings.HEIGHT / 2, new ReplicaCarbonhydrate());
