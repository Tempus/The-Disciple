...
public class EchowardPower extends AbstractPower
{
  ...
  public EchowardPower(AbstractCreature owner, boolean upgraded)
  {
    ...
    this.amount = 1;
    updateDescription();
    this.region128 = new TextureAtlas.AtlasRegion(new Texture("images/powers/Echoward.png"), 0, 0, 84, 84);
    this.region48 = new TextureAtlas.AtlasRegion(new Texture("images/powers/EchowardSmall.png"), 0, 0, 32, 32);
