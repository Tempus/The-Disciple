...
public class DelayedBlockPower extends AbstractPower
{
  ...
  public DelayedBlockPower(AbstractCreature owner, int turns, int block)
  {
    ...
    this.region128 = new TextureAtlas.AtlasRegion(new Texture("images/powers/DelayedBlock.png"), 0, 0, 84, 84);
    this.region48 = new TextureAtlas.AtlasRegion(new Texture("images/powers/DelayedBlockSmall.png"), 0, 0, 32, 32);
  }
